-- Reassign all staging data to your user_id
-- Run this in STAGING Supabase SQL Editor
-- 
-- Your user_id from JWT: ff6e0c97-6f0a-4415-9fba-451667641863
-- Current data user_id: 5d7690ff-a4b2-4c82-a1b9-73aaefdf3321

-- Reassign all data to your user_id
UPDATE clients 
SET user_id = 'ff6e0c97-6f0a-4415-9fba-451667641863' 
WHERE user_id = '5d7690ff-a4b2-4c82-a1b9-73aaefdf3321' OR user_id IS NULL;
