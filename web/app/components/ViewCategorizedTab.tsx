        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          ...
          {isLoading ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-separate border-spacing-0 border border-gray-400" style={{ borderCollapse: 'separate', borderSpacing: 0 }}>
                <thead className="bg-gray-50 border-b-2 border-gray-400">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-b-2 border-gray-400">
                      Name
                    </th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-b-2 border-gray-400">
                      Handle
                    ...
                    <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b-2 border-gray-400">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="bg-white">
                  {pages.map((page) => (
                    <tr key={page.id} className="hover:bg-gray-50">
                      {/* Name */}
                      <td className="px-4 py-5 border-r border-b border-gray-400">
                      ...
                      {/* Notes */}
                      <td className="px-4 py-5 max-w-xs border-r border-b border-gray-400">
                      ...
                      {/* Actions */}
                      <td className="px-4 py-5 border-b border-gray-400">
                        <a
